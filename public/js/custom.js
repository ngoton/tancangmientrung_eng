...
/**/
  ...
  if($('#chonngaytaobatdau') != null)
  {
    ...
    var dataString = 'keyword='+ faq_search_input+"&limit="+loc+"&page="+ page +"&order_by="+ cot +"&order="+ sapxep+"&ngaytao="+ ngaytao+"&ngaytaobatdau="+ ngaytaobatdau; 
...
function sapxep(page,cot,sapxep){
        ...
        if(page==""){
          ...
          $.ajax({
            ...
            data: "page="+ page +"&order_by="+ cot +"&order="+ sapxep+"&keyword="+ keyword+"&ngaytao="+ ngaytao+"&ngaytaobatdau="+ ngaytaobatdau, // giá trị post
